...
export default function BlockEditorModal({
    ...
    const isBlockNameAutoGeneratedRef = useRef(false)
    ...
    const loadBlock = useCallback(async (id) => {
        ...
        try {
            ...
            isBlockNameAutoGeneratedRef.current = false
    ...
    function handleFieldChange(event) {
        ...
        setForm((currentForm) => {
            ...
            const isTransferRouteField
                = currentForm.blockType === 'transfer' && (name === 'transferDeparture' || name === 'transferArrival')

            const canAutoGenerateBlockName =
                currentForm.blockName.trim() === '' || isBlockNameAutoGeneratedRef.current

            if (!isTransferRouteField || !canAutoGenerateBlockName) {
                return nextForm
            }

            const departure = name === 'transferDeparture'
                ? value.trim()
                : currentForm.transferDeparture.trim()

            const arrival = name === 'transferArrival'
                ? value.trim()
                : currentForm.transferArrival.trim()

            if (departure !== '' && arrival !== '') {
                nextForm.blockName = `${departure} → ${arrival}`
                isBlockNameAutoGeneratedRef.current = true
            }
...
function BlockNameField({ form, disabled, onChange }) {
    return (
...
function ActivityTypeField({ form, disabled, onChange }) {
    return (
...
function BlockPlaceCostDurationFields({ form, disabled, onChange }) {
    return (
        <div className="block-editor-field-row block-editor-field-row-three-columns">
            <div className="block-editor-field">
...
function BlockDetailsField({ form, disabled, onChange }) {
    return (
        <div className="block-editor-field">
...
function TransferRouteFields({ form, disabled, onChange }) {
    return (
...
function TransferTimeFields({ form, disabled, onChange }) {
    return (
        <section className="block-editor-type-fields">
            <div className="block-editor-field-row">
                <div className="block-editor-field">
                    <label htmlFor="transfer-departure-time">
                        出発時刻
                    </label>
                ...
                <div className="block-editor-field">
                    <label htmlFor="transfer-arrival-time">
                        到着時刻
                    </label>
