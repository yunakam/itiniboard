...
public record BlockDetailResponse(
    ...
    public static BlockDetailResponse fromActivity(Block block, Activity activity) {
    ...
    public static BlockDetailResponse fromTransfer(Block block, Transfer transfer) {
        return new BlockDetailResponse(
                block.getBlockId(),
                block.getBlockType(),
                block.getBlockName(),
